...
export const MOCK_REVIEWS = [
  ...
  { id: 'r11', type: 'worker_about_company', authorId: 'w1', targetId: 'c1', shiftId: 's21', overallRating: 5, categoryRatings: { conditions: 5, descriptionMatch: 5, attitude: 5, paymentSpeed: 5 }, text: null, anonymous: false, recommendAgain: null, createdAt: addDays(-3) },
  { id: 'r12', type: 'worker_about_company', authorId: 'w8', targetId: 'c1', shiftId: 's21', overallRating: 4, categoryRatings: { conditions: 4, descriptionMatch: 4, attitude: 3, paymentSpeed: 5 }, text: 'Много работы, но платят.', anonymous: false, recommendAgain: null, createdAt: addDays(-5) },
  { id: 'r13', type: 'worker_about_company', authorId: 'w2', targetId: 'c3', shiftId: 's22', overallRating: 4, categoryRatings: { conditions: 4, descriptionMatch: 4, attitude: 4, paymentSpeed: 3 }, text: 'Ресторан хороший, но оплата задерживается.', anonymous: false, recommendAgain: null, createdAt: addDays(-6) },
  { id: 'r14', type: 'worker_about_company', authorId: 'w6', targetId: 'c3', shiftId: 's22', overallRating: 5, categoryRatings: { conditions: 5, descriptionMatch: 5, attitude: 5, paymentSpeed: 5 }, text: 'ТЦ очень удобно расположен, работать приятно.', anonymous: false, recommendAgain: null, createdAt: addDays(-4) },
  { id: 'r15', type: 'worker_about_company', authorId: 'w3', targetId: 'c5', shiftId: 's23', overallRating: 4, categoryRatings: { conditions: 4, descriptionMatch: 4, attitude: 4, paymentSpeed: 4 }, text: null, anonymous: false, recommendAgain: null, createdAt: addDays(-8) },
  { id: 'r16', type: 'worker_about_company', authorId: 'w5', targetId: 'c5', shiftId: 's23', overallRating: 4, categoryRatings: { conditions: 3, descriptionMatch: 4, attitude: 5, paymentSpeed: 5 }, text: 'Склад далеко, но условия нормальные.', anonymous: false, recommendAgain: null, createdAt: addDays(-7) },
  { id: 'r17', type: 'worker_about_company', authorId: 'w4', targetId: 'c7', shiftId: 's24', overallRating: 5, categoryRatings: { conditions: 5, descriptionMatch: 5, attitude: 5, paymentSpeed: 5 }, text: 'Первая смена, всё понравилось!', anonymous: false, recommendAgain: null, createdAt: addDays(-3) },
  { id: 'r18', type: 'worker_about_company', authorId: 'w10', targetId: 'c7', shiftId: 's24', overallRating: 5, categoryRatings: { conditions: 5, descriptionMatch: 5, attitude: 5, paymentSpeed: 5 }, text: null, anonymous: false, recommendAgain: null, createdAt: addDays(-2) },
  { id: 'r19', type: 'worker_about_company', authorId: 'w7', targetId: 'c8', shiftId: 's25', overallRating: 4, categoryRatings: { conditions: 4, descriptionMatch: 4, attitude: 4, paymentSpeed: 5 }, text: 'Стабильно и предсказуемо, это хорошо.', anonymous: false, recommendAgain: null, createdAt: addDays(-7) },
  { id: 'r20', type: 'worker_about_company', authorId: 'w8', targetId: 'c1', shiftId: 's21', overallRating: 5, categoryRatings: { conditions: 5, descriptionMatch: 5, attitude: 5, paymentSpeed: 5 }, text: 'Лучшее кафе для подработки!', anonymous: false, recommendAgain: null, createdAt: addDays(-5) },
  ...
  { id: 'r30', type: 'company_about_worker', authorId: 'c3', targetId: 'w2', shiftId: 's22', overallRating: 4, categoryRatings: { punctuality: 5, workQuality: 4, communication: 3, appearance: 4 }, text: 'Старательный, но не хватает навыков общения с гостями.', anonymous: false, recommendAgain: true, createdAt: addDays(-5) },

  // More company about worker
  { id: 'r31', type: 'company_about_worker', authorId: 'c1', targetId: 'w1', shiftId: 's21', overallRating: 5, categoryRatings: { punctuality: 5, workQuality: 5, communication: 5, appearance: 5 }, text: null, anonymous: false, recommendAgain: true, createdAt: addDays(-3) },
  { id: 'r32', type: 'company_about_worker', authorId: 'c1', targetId: 'w8', shiftId: 's21', overallRating: 5, categoryRatings: { punctuality: 5, workQuality: 5, communication: 5, appearance: 5 }, text: 'Лучший оператор ПВЗ!', anonymous: false, recommendAgain: true, createdAt: addDays(-8) },
  { id: 'r33', type: 'company_about_worker', authorId: 'c3', targetId: 'w6', shiftId: 's22', overallRating: 5, categoryRatings: { punctuality: 5, workQuality: 5, communication: 5, appearance: 5 }, text: 'Прекрасный промоутер!', anonymous: false, recommendAgain: true, createdAt: addDays(-4) },
  { id: 'r34', type: 'company_about_worker', authorId: 'c5', targetId: 'w3', shiftId: 's23', overallRating: 4, categoryRatings: { punctuality: 4, workQuality: 4, communication: 5, appearance: 4 }, text: null, anonymous: false, recommendAgain: true, createdAt: addDays(-7) },
  { id: 'r35', type: 'company_about_worker', authorId: 'c5', targetId: 'w5', shiftId: 's23', overallRating: 4, categoryRatings: { punctuality: 4, workQuality: 4, communication: 5, appearance: 5 }, text: 'Улыбчивая и приятная.', anonymous: false, recommendAgain: true, createdAt: addDays(-6) },
  { id: 'r36', type: 'company_about_worker', authorId: 'c7', targetId: 'w4', shiftId: 's24', overallRating: 4, categoryRatings: { punctuality: 4, workQuality: 4, communication: 4, appearance: 4 }, text: 'Для новичка — молодец.', anonymous: false, recommendAgain: true, createdAt: addDays(-3) },
  { id: 'r37', type: 'company_about_worker', authorId: 'c7', targetId: 'w10', shiftId: 's24', overallRating: 5, categoryRatings: { punctuality: 5, workQuality: 5, communication: 4, appearance: 4 }, text: null, anonymous: false, recommendAgain: true, createdAt: addDays(-5) },
  { id: 'r38', type: 'company_about_worker', authorId: 'c8', targetId: 'w7', shiftId: 's25', overallRating: 5, categoryRatings: { punctuality: 5, workQuality: 5, communication: 5, appearance: 5 }, text: 'Идеально!', anonymous: false, recommendAgain: true, createdAt: addDays(-2) },
  { id: 'r39', type: 'company_about_worker', authorId: 'c1', targetId: 'w1', shiftId: 's21', overallRating: 2, categoryRatings: { punctuality: 2, workQuality: 2, communication: 2, appearance: 3 }, text: 'Не справился с задачей.', anonymous: false, recommendAgain: false, createdAt: addDays(-1) },
  { id: 'r40', type: 'company_about_worker', authorId: 'c3', targetId: 'w2', shiftId: 's22', overallRating: 5, categoryRatings: { punctuality: 5, workQuality: 5, communication: 5, appearance: 5 }, text: 'Суперработник! Надёжная и аккуратная.', anonymous: false, recommendAgain: true, createdAt: addDays(-7) },
];
