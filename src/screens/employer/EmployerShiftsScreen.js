...
const styles = StyleSheet.create({
  ...
  filters: { paddingHorizontal: SIZES.lg, gap: SIZES.sm, marginBottom: SIZES.md },
  filterChip: { paddingHorizontal: SIZES.md, paddingVertical: SIZES.sm, borderRadius: SIZES.radiusFull, backgroundColor: COLORS.white, borderWidth: 1, borderColor: COLORS.border },
